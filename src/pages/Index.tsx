...
const Index = () => {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "Hi there! 👋 I'm CareerMate, your friendly career guidance companion. I'm here to help you discover career paths that match your interests and skills.\n\nTo get started, tell me a bit about yourself:\n• What subjects or topics do you enjoy?\n• What are you good at?\n• What's your current education level?",
    },
  ]);
  ...
  const streamChat = async (userMessage: string) => {
    ...
    try {
      ...
      setMessages((prev) => prev.filter((m) => m !== newMessages[newMessages.length - 1]));
    } finally {
      setIsLoading(false);
    }
  };
